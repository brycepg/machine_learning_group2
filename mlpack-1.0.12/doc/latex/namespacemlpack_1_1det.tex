...
\subsubsection[{Print\-Leaf\-Membership}]{\setlength{\rightskip}{0pt plus 5cm}void mlpack\-::det\-::\-Print\-Leaf\-Membership (
\begin{DoxyParamCaption}
\item[{D\-Tree $\ast$}]{dtree, }
\item[{const arma\-::mat \&}]{data, }
\item[{const arma\-::\-Mat$<$ size\-\_\-t $>$ \&}]{labels, }
\item[{const size\-\_\-t}]{num\-Classes, }
\item[{const std\-::string}]{leaf\-Class\-Membership\-File = {\ttfamily \char`\"{}\char`\"{}}}
\end{DoxyParamCaption}
)}\label{namespacemlpack_1_1det_aa47b4eeebeb1cfaec56b97a9e0f46bf5}
...
\subsubsection[{Print\-Variable\-Importance}]{\setlength{\rightskip}{0pt plus 5cm}void mlpack\-::det\-::\-Print\-Variable\-Importance (
\begin{DoxyParamCaption}
\item[{const D\-Tree $\ast$}]{dtree, }
\item[{const std\-::string}]{vi\-File = {\ttfamily \char`\"{}\char`\"{}}}
\end{DoxyParamCaption}
)}\label{namespacemlpack_1_1det_aeee50c5f4c8d0cec3b88313e84965773}
...
\subsubsection[{Trainer}]{\setlength{\rightskip}{0pt plus 5cm}{\bf D\-Tree}$\ast$ mlpack\-::det\-::\-Trainer (
\begin{DoxyParamCaption}
\item[{arma\-::mat \&}]{dataset, }
...
\item[{const std\-::string}]{unpruned\-Tree\-Output = {\ttfamily \char`\"{}\char`\"{}}}
\end{DoxyParamCaption}
)}\label{namespacemlpack_1_1det_ac00c29df49a801a81ad64514a9eaa3ba}
