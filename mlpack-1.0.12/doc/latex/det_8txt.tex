...
Tutorial for how to perform density estimation with Density Estimation Trees (D\-E\-T). \begin{DoxyAuthor}{Author}
Parikshit Ram 
\end{DoxyAuthor}


Definition in file {\bf det.\-txt}.
...
\subsubsection[{\$\-V}]{\setlength{\rightskip}{0pt plus 5cm}f f \$V (
...
\subsubsection[{alpha}]{\setlength{\rightskip}{0pt plus 5cm}see subsection cli\-\_\-alt\-\_\-reg\-\_\-tut Alternate D\-E\-T {\bf regularization} The usual regularized error f \$R\-\_\- alpha (
\begin{DoxyParamCaption}
\item[{t}]{}
\end{DoxyParamCaption}
