...
{\bf Prefixed\-Out\-Stream} \& {\bf operator$<$$<$} (std\-::string \&str)
...
\begin{DoxyCompactList}\small\item\em The output stream that all data is to be sent too; example\-: std\-::cout. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactItemize}
\item 
{\footnotesize template$<$typename T $>$ }\\void {\bf Base\-Logic} (const T \&val)
...
{\footnotesize template$<$typename T $>$ }\\void {\bf Call\-Base\-Logic} (const T \&s, typename boost\-::disable\-\_\-if$<$ boost\-::is\-\_\-class$<$ T $>$ $>$\-::type $\ast$=0)
\begin{DoxyCompactList}\small\item\em This handles forwarding all primitive types transparently. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename T $>$ }\\void {\bf Call\-Base\-Logic} (const T \&s, typename boost\-::enable\-\_\-if$<$ boost\-::is\-\_\-class$<$ T $>$ $>$\-::type $\ast$=0, typename boost\-::disable\-\_\-if$<$ Has\-To\-String$<$ T, std\-::string(T\-::$\ast$)() const  $>$ $>$\-::type $\ast$=0)
\begin{DoxyCompactList}\small\item\em Forward all objects that do not implement a To\-String() method. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename T $>$ }\\void {\bf Call\-Base\-Logic} (const T \&s, typename boost\-::enable\-\_\-if$<$ boost\-::is\-\_\-class$<$ T $>$ $>$\-::type $\ast$=0, typename boost\-::enable\-\_\-if$<$ Has\-To\-String$<$ T, std\-::string(T\-::$\ast$)() const  $>$ $>$\-::type $\ast$=0)
\begin{DoxyCompactList}\small\item\em Call To\-String() on all objects that implement To\-String() before forwarding. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em If true, the previous call to operator$<$$<$ encountered a C\-R, and a prefix will be necessary. \end{DoxyCompactList}\item 
bool {\bf fatal}
\begin{DoxyCompactList}\small\item\em If true, the application will terminate with an error code when a C\-R is encountered. \end{DoxyCompactList}\item 
std\-::string {\bf prefix}
...
These objects are used for the \doxyref{mlpack\-::\-Log}{p.}{classmlpack_1_1Log} levels (D\-E\-B\-U\-G, I\-N\-F\-O, W\-A\-R\-N, and F\-A\-T\-A\-L). 
...
\index{Prefixed\-Out\-Stream@{Prefixed\-Out\-Stream}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
\subsubsection[{Prefixed\-Out\-Stream}]{\setlength{\rightskip}{0pt plus 5cm}mlpack\-::util\-::\-Prefixed\-Out\-Stream\-::\-Prefixed\-Out\-Stream (
...
\index{Base\-Logic@{Base\-Logic}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
\subsubsection[{Base\-Logic}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ void mlpack\-::util\-::\-Prefixed\-Out\-Stream\-::\-Base\-Logic (
\begin{DoxyParamCaption}
\item[{const T \&}]{val}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{classmlpack_1_1util_1_1PrefixedOutStream_a27875e651240f4dc2d195d9d06028589}
...
\hline
\end{DoxyParams}
\index{mlpack\-::util\-::\-Prefixed\-Out\-Stream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}!Call\-Base\-Logic@{Call\-Base\-Logic}}
\index{Call\-Base\-Logic@{Call\-Base\-Logic}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
\subsubsection[{Call\-Base\-Logic}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ void mlpack\-::util\-::\-Prefixed\-Out\-Stream\-::\-Call\-Base\-Logic (
\begin{DoxyParamCaption}
\item[{const T \&}]{s, }
\item[{typename boost\-::disable\-\_\-if$<$ boost\-::is\-\_\-class$<$ T $>$ $>$\-::type $\ast$}]{ = {\ttfamily 0}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{classmlpack_1_1util_1_1PrefixedOutStream_a6d41b68155c23303d667f64c8f919ee8}
...
\begin{DoxyParamCaption}
\item[{const T \&}]{s, }
\item[{typename boost\-::enable\-\_\-if$<$ boost\-::is\-\_\-class$<$ T $>$ $>$\-::type $\ast$}]{ = {\ttfamily 0}, }
\item[{typename boost\-::disable\-\_\-if$<$ Has\-To\-String$<$ T, std\-::string(T\-::$\ast$)() const  $>$ $>$\-::type $\ast$}]{ = {\ttfamily 0}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{classmlpack_1_1util_1_1PrefixedOutStream_ab9d82de834eaa08cac09c21385e224da}


Forward all objects that do not implement a To\-String() method. 
...
\item[{const T \&}]{s, }
\item[{typename boost\-::enable\-\_\-if$<$ boost\-::is\-\_\-class$<$ T $>$ $>$\-::type $\ast$}]{ = {\ttfamily 0}, }
\item[{typename boost\-::enable\-\_\-if$<$ Has\-To\-String$<$ T, std\-::string(T\-::$\ast$)() const  $>$ $>$\-::type $\ast$}]{ = {\ttfamily 0}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{classmlpack_1_1util_1_1PrefixedOutStream_aea76f955eebf6224ea95253a6d367025}


Call To\-String() on all objects that implement To\-String() before forwarding. 

\index{mlpack\-::util\-::\-Prefixed\-Out\-Stream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}!operator$<$$<$@{operator$<$$<$}}
\index{operator$<$$<$@{operator$<$$<$}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
\subsubsection[{operator$<$$<$}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Prefixed\-Out\-Stream}\& mlpack\-::util\-::\-Prefixed\-Out\-Stream\-::operator$<$$<$ (
\begin{DoxyParamCaption}
\item[{bool}]{val}
\end{DoxyParamCaption}
...
\index{mlpack\-::util\-::\-Prefixed\-Out\-Stream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}!operator$<$$<$@{operator$<$$<$}}
\index{operator$<$$<$@{operator$<$$<$}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
\subsubsection[{operator$<$$<$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ {\bf Prefixed\-Out\-Stream}\& mlpack\-::util\-::\-Prefixed\-Out\-Stream\-::operator$<$$<$ (
\begin{DoxyParamCaption}
\item[{const T \&}]{s}
\end{DoxyParamCaption}
...
\index{Prefix\-If\-Needed@{Prefix\-If\-Needed}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
...
\index{carriage\-Returned@{carriage\-Returned}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
...
If true, the previous call to operator$<$$<$ encountered a C\-R, and a prefix will be necessary. 
...
\index{destination@{destination}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
...
\index{fatal@{fatal}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
...
If true, the application will terminate with an error code when a C\-R is encountered. 
...
\index{ignore\-Input@{ignore\-Input}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
...
\index{prefix@{prefix}!mlpack::util::PrefixedOutStream@{mlpack\-::util\-::\-Prefixed\-Out\-Stream}}
\subsubsection[{prefix}]{\setlength{\rightskip}{0pt plus 5cm}std\-::string mlpack\-::util\-::\-Prefixed\-Out\-Stream\-::prefix\hspace{0.3cm}{\ttfamily [private]}}\label{classmlpack_1_1util_1_1PrefixedOutStream_a33664a47377732ed8d5ca18e104eff5e}
